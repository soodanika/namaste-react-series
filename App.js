...
const restaurants = [
    {
      ...
      "analytics": {
        "context": "seo-data-91cb2cc2-5fa0-4481-90d1-492bd793a358"
      },
      "cta": {
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-08-23 15:30:00",
          "opened": true
        },
        "badges": {
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-08-23 11:59:00",
          "opened": true
        },
        "badges": {
    ...
    },
    {
      ...
      "cta": {
        "link": "https://www.swiggy.com/restaurants/paakashala-shanthinagara-indiranagar-bangalore-743426",
        "text": "RESTAURANT_MENU",
        "type": "WEBLINK"
      },
      "widgetId": "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo"
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-08-24 00:00:00",
          "opened": true
        },
        "badges": {
          "textExtendedBadges": [
    ...
    return (
        <div className='header-container'>
            <div className='logo-conatainer'>
                <img className='logo' alt="logo" src="https://png.pngtree.com/png-clipart/20230106/original/pngtree-simple-and-modern-food-logo-vector-design-png-image_8876455.png"></img>
            </div>
...
// console.log(props)
    ...
    return (
        <div className='res-card'>
            <img className="image" alt="res-image" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId}></img>
            <h3>{name}</h3>
            <h4>{cuisines.join(", ")}</h4>
